...
export function Footer() {
  ...
  return (
    <footer className="py-16 px-6" style={{ background: "#111111", color: "#9ca3af" }}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <span className="font-bold text-white text-base font-[family-name:var(--font-heading)]">
                {t("brand")}
              </span>
            </div>
          ...
          {/* Services */}
          <div>
            <h4 className="text-white text-sm font-semibold mb-5 font-[family-name:var(--font-heading)]">
              {t("servicesTitle")}
            </h4>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg text-sm placeholder-gray-600 outline-none text-gray-200"
                style={{
