...
interface LiveCameraFeedProps {
  ...
  boxes?: BoundingBox[];
  mode?: "plate" | "face";
  /** Manual single-shot capture (e.g. a "Capture & Detect" button). */
  onCapture?: (blob: Blob) => void;
  capturing?: boolean;
  /** Continuous auto-capture on an interval, for live streaming detection. */
...
export function LiveCameraFeed({
  ...
  }, [streaming, onFrame, frameIntervalMs]);
      ...
      <div className="relative aspect-video w-full">
        ...
        {streaming &&
          boxes.map((b) => (
            ...
            >
              <div
                className={`absolute -top-6 left-0 flex items-center gap-1 rounded px-1.5 py-0.5 text-[10px] font-mono ${toneText(b.tone)}`}
              >
                <span>{b.label}</span>
